...
discipline** of the ``search`` mode (``agent/workflow/pipeline.py``): the itinerary
is built from REAL retrieved onsen records — never LLM-generated, never
fabricated — so there is NO LLM call in the
