...
// only when API_KEY is set, so local/test environments without a key send no
// header (and the backend, if also keyless in local dev, can stay open).
//
// Base URL and key come from src/config.js — not hardcoded here.
